...
})(
  {
    ...
    5: [
      function (require, module, exports) {
        ...
        exports.ChessDataViz = undefined;

        var _util = require("./util");

        var util = _interopRequireWildcard(_util);

        var _EvalAndTime = require("./EvalAndTime");

        var _HeatMap = require("./HeatMap");

        var _Openings = require("./Openings");

        var _MovePaths = require("./MovePaths");
        ...
        var ChessDataViz = (exports.ChessDataViz = {
          EvalAndTime: _EvalAndTime.EvalAndTime,
          HeatMap: _HeatMap.HeatMap,
          Openings: _Openings.Openings,
          MovePaths: _MovePaths.MovePaths,
          util: util,
        });
    ...
    6: [
      function (require, module, exports) {
        ...
        var log = (0, _debug2.default)("cdv:EvalAndTime");

        var EvalAndTime = (function () {
          function EvalAndTime(selector, options, data) {
            var _this = this;

            _classCallCheck(this, EvalAndTime);

            var self = this;

            //container
            this.container = d3v3.select(selector);
            ...
            //scales
            this._xScale = d3v3.scale
              .ordinal()
              .rangeBands([0, this._width], 0.1, 0);

            this._yEvalScale = d3v3.scale
              .linear()
              .range([this._height, 0])
              .domain([-5, 5])
              .clamp(true);

            this._yTimeScale = d3v3.scale.linear().range([this._height, 0]);

            //axes
            this._xAxis = d3v3.svg
              .axis()
              .scale(this._xScale)
              .orient("top")
            ...
            this._yEvalAxis = d3v3.svg
              .axis()
              .scale(this._yEvalScale)
              .orient("left");

            this._yTimeAxis = d3v3.svg
              .axis()
            ...
            //eval guide lines
            var evalGuides = svg.append("g").attr("class", "eval-guides");

            var evalGuideLines = [0.5, -0.5, 1, -1, 2, -2];
            ...
            evalGuides
              ...
              .attr("transform", function (d) {
                ...
                return "translate(5," + (_this._yEvalScale(d.y) + offset) + ")";
              })
              .text(function (d) {
                return d.text;
              })
            ...
            interactiveLayer
              ...
              .on("mousemove", function () {
                ...
                var mouseX = d3v3.mouse(this)[0];
                var leftEdges = self._xScale.range();
                var width = self._xScale.rangeBand();
                var j = undefined;
                for (j = 0; mouseX > leftEdges[j] + width; j++) {}

                //convert it to the range on screen
                var xPoint = self._xScale.domain()[j];
                var xPosition =
                  self._xScale(xPoint) + self._xScale.rangeBand() / 2;
                ...
                //draw yEval guide
                var yPosition = self._yEvalScale(self._data[xPoint].score);
          ...
          _createClass(EvalAndTime, [
            ...
            },
            {
              ...
              value: function options(_options) {
                var omit = ["width", "margin", "boardWidth", "squareWidth"];

                _lodash2.default.merge(
                  this._options,
                  _lodash2.default.omit(_options, omit)
                );

                if (_lodash2.default.isArray(this._options.colorScale)) {
            ...
            },
            {
              ...
              value: function update() {
                ...
                //set scale domains
                this._xScale.domain(d3v3.range(this._data.length));

                var y2max = d3v3.max(
                  d3v3
                    .extent(this._data, function (d) {
                      return d.time;
                    })
                    .map(Math.abs)
                );
                ...
                this._xAxis.tickValues(
                  this._xScale.domain().filter(function (d, i) {
                    return i == 0 || !((i + 1) % 10);
                  })
                );
                ...
                var line = d3v3.svg
                  .line()
                  .x(function (d, i) {
                    return _this2._xScale(i) + _this2._xScale.rangeBand() / 2;
                  })
                  .y(function (d) {
                    return _this2._yEvalScale(d.score);
                  });
                ...
                bars
                  .transition()
                  .delay(function (d, i) {
                    return (i / _this2._xScale.domain().length) * 500;
                  })
                  .attr("x", function (d, i) {
                    return _this2._xScale(i);
                  })
                  .attr("width", this._xScale.rangeBand())
                  .attr("y", function (d) {
                    if (d.time > 0) {
                      return _this2._yTimeScale(d.time);
                    } else {
                      return _this2._yTimeScale(0);
                    }
                  })
                  .attr("height", function (d) {
                    if (d.time > 0) {
                      return _this2._yTimeScale(0) - _this2._yTimeScale(d.time);
                    } else {
                      return _this2._yTimeScale(d.time) - _this2._yTimeScale(0);
                    }
                  })
                ...
                //lines
                var lines = this.container.select(".lines").selectAll(".line");
                ...
                //areas
                var areas = this.container.select(".areas").selectAll(".area");
        ...
        exports.EvalAndTime = EvalAndTime;
      },
      { debug: 1, lodash: 3 },
    ],
    7: [
      function (require, module, exports) {
        ...
        var log = (0, _debug2.default)("cdv:HeatMap");

        var HeatMap = (function () {
          function HeatMap(selector, options, data) {
            ...
            //scales
            this._scale = {
              size: d3v3.scale.linear().range([0, this._options.squareWidth]),
              color: d3v3.scale.linear().range(["blue", "red"]),
            };
          ...
          _createClass(HeatMap, [
            ...
            },
            {
              ...
              value: function update() {
                ...
                //adjust scales
                var extent = d3v3.extent(this._data, function (d) {
                  return d[
                    _this._options.accessor.piece
                  ][_this._options.accessor.color];
                });
                ...
                //update heat squares
                var heatSquares = this.dataContainer
                ...
                heatSquares
                  ...
                  .attr("x", function (d, i) {
                    return (
                      (i % 8) * _this._options.squareWidth +
                      _this._options.squareWidth / 2
                    );
                  })
                  .attr("y", function (d, i) {
                    return (
                      Math.floor(i / 8) * _this._options.squareWidth +
                      _this._options.squareWidth / 2
                    );
                  })
                  .attr("width", function (d) {
                    return squareSize(d) + "px";
                  })
                  .attr("height", function (d) {
                    return squareSize(d) + "px";
                  })
                  .attr("transform", function (d) {
                    var halfWidth = squareSize(d) / 2;
                  ...
                  .on("mouseenter", function (d, i) {
                    _this.dispatch.mouseenter(
                      d[_this._options.accessor.piece][
                        _this._options.accessor.color
                      ]
                    );
                  })
                ...
                function squareSize(d) {
                  ...
                  if (self._options.sizeScale) {
                    size = self._scale.size(
                      d[self._options.accessor.piece][
                        self._options.accessor.color
                      ]
                    );
                  } else {
    ...
    8: [
      function (require, module, exports) {
        ...
        var log = (0, _debug2.default)("cdv:MovePaths");

        var MovePaths = (function () {
          function MovePaths(selector, options, data) {
            _classCallCheck(this, MovePaths);
            ...
            var defaultOptions = {
              ...
              accessor: "Nb1",
              binSize: 1,
              pointRandomizer: d3v3.random.normal(3, 1),
              bezierRandomizer: d3v3.random.normal(12, 4),
              bezierScaleFactor: 2,
            };
            ...
            },
            {
              ...
              value: function update() {
                ...
                _lodash2.default
                  ...
                  .forEach(function (d) {
                    var bin = Math.ceil(d[1] / _this._options.binSize);
                ...
                this.dataContainer
                  ...
                  .attr("d", function (d) {
                    ...
                    var _getSquareCoords = getSquareCoords(d);

                    var _getSquareCoords2 = _slicedToArray(_getSquareCoords, 2);

                    var s = _getSquareCoords2[0];
                    var e = _getSquareCoords2[1];
                    ...
                    var scaleFactor =
                      ...
                      ) / _this._options.bezierScaleFactor;
                    ...
                    s.x += _this._options.pointRandomizer();
                    s.y += _this._options.pointRandomizer();
                    e.x += _this._options.pointRandomizer();
                    e.y += _this._options.pointRandomizer();
                    controlPoint.x += _this._options.bezierRandomizer();
                    controlPoint.y += _this._options.bezierRandomizer();
                ...
                function getSquareCoords(d) {
                  ...
                  for (var i = 0; i < 2; i++) {
                    var square = d.split("-")[i].toLowerCase();

                    var file = square.charCodeAt(0) - 97;
                    var rank = 8 - square[1];

                    var x =
                      file * self._options.squareWidth +
                      self._options.squareWidth / 2;
                    var y =
                      rank * self._options.squareWidth +
                      self._options.squareWidth / 2;
    ...
    9: [
      function (require, module, exports) {
        ...
        var log = (0, _debug2.default)("cdv:Openings");
        ...
        var Openings = (function () {
          function Openings(selector, options, data) {
            ...
            var radius =
              Math.min(this._options.width, this._options.height) / 2;

            var xScale = d3v3.scale.linear().range([0, 2 * Math.PI]);
            var yScale = d3v3.scale.sqrt().range([0, radius]);
              ...
              value: function update() {
                ...
                arcs
                  ...
                  .attrTween("d", function (d) {
                    var interpolate = d3v3.interpolate(
                      {
                        x: this.x0,
                        dx: this.dx0,
                      },
                ...
                function fillColor(d, i) {
                  ...
                  var color = d3v3.hsl(self._options.colors(rootParent.san));
    ...
    10: [
      function (require, module, exports) {
        ...
        function parseMinutes(move, i) {
          var min = move.time.match(/(\d+)m/);
          min = min ? +min[1] : 0;

          var sec = move.time.match(/(\d+)s/);
          sec = sec ? +sec[1] : 0;
        ...
        function parseGameNotation(notation) {
          notation.map(function (move, i) {
            return (move.time = parseMinutes(move, i));
          });
          notation.map(function (move) {
            return (move.score = parseScore(move));
          });
        ...
        function drawBoard(svg, squareWidth) {
          //board squares
          ...
          var squares = svg
            ...
            .append("g")
            .attr("class", function (d) {
              var file = String.fromCharCode(97 + d.x);
              var rank = 8 - d.y;
          ...
          squares
            .append("rect")
            .attr("x", function (d) {
              return d.x * squareWidth;
            })
            .attr("y", function (d) {
              return d.y * squareWidth;
            })
          ...
          var fileLabels = d3v3.range(8).map(function (i) {
            return ".a" + (i + 1);
          });
          ...
          var files = d3v3.range(8).map(function (i) {
            return String.fromCharCode(97 + i);
          });
          var rankLabels = files.slice().map(function (file) {
            return "." + file + "1";
          });
          ...
          svg
            ...
            .append("text")
            .attr("x", function (d) {
              return (d.x + 1) * squareWidth;
            })
            .attr("y", function (d) {
              return (d.y + 1) * squareWidth;
            })
            .attr("dx", "-0.3em")
            .attr("dy", "-0.5em")
