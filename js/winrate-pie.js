...
function updateExplanationText(filter) {
  ...
  if (filter === 'aaron') {
    ...
    explanationElement.innerHTML += `
      ...
      <p>The second game features Aaron against former Canadian Champion and current top-Canadian GM Evgeny Bareev where he is able to hold a draw as black at just 10 years of age.</p>
      <p>The third game Aaron plays IM Nikolay Noritsyn and his tactical calculation and foresight to trade into an endgame.</p>
    ...
    explanationElement.innerHTML += `
      ...
      <p>The first game demonstrates his tactical play to defeat IM Shawn Rodrigue Lemiuex at the 2023 Canadian Championship.</p>
      <p>The second game features Nikolay's immaculate defence against a GM at the Maplewood Invitational.</p>
